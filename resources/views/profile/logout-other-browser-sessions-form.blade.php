<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puedes cerrar la sesión en todos tus otros navegadores en todos tus dispositivos. A continuación se muestran algunas de tus sesiones recientes; sin embargo, esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también debes actualizar tu contraseña.') }}
        </div>
        ...
        <x-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Ingresa tu contraseña para confirmar que deseas cerrar la sesión en tus otros navegadores en todos tus dispositivos.') }}
